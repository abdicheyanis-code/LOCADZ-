...
// ✅ LES 3 POINTS EXACTEMENT COMME TU LES VEUX
const WHY_LOCADZ: Record<AppLanguage, { title: string; points: { icon: string; title: string; desc: string }[] }> = {
  fr: {
    ...
    points: [
      ...
      { icon: "🖱️", title: "Réservation simple", desc: "En quelques clics seulement" },
      { icon: "🚀", title: "Pionnier", desc: "La 1ère plateforme de villas en Algérie" }
    ]
  },
  en: {
    title: "Why LocaDZ?",
    points: [
      ...
      { icon: "🖱️", title: "Simple booking", desc: "In just a few clicks" },
      { icon: "🚀", title: "Pioneer", desc: "The 1st villa platform in Algeria" }
    ]
  },
  ar: {
    title: "لماذا LocaDZ؟",
    points: [
      ...
      { icon: "🖱️", title: "حجز سهل", desc: "بضع نقرات فقط" },
      { icon: "🚀", title: "رائد", desc: "أول منصة فيلات في الجزائر" }
    ]
  }
};
